...
public abstract class AbstractFanHandler implements Handler {
    
    protected List<String> supportedCommands;

    public AbstractFanHandler(List<String> supportedCommands) {
    ...
    protected abstract void changeSpeed(int speed);
}
