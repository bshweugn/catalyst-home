...
const Bell = ({ size = '24px', fill = 'currentColor', className = '', ...props }) => {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18.7891 20.5566">
        <g>
          <rect height="20.5566" opacity="0" width="18.7891" x="0" y="0" />
